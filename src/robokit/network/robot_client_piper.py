...
class RobotClientPiper:
    ...
    def __init__(self, ros: roslibpy.Ros):
        ...
        self.moveit_endpose_service = roslibpy.Service(
            self._ros, '/joint_moveit_ctrl_endpose', 'moveit_ctrl/JointMoveitCtrl')
    ...
    def moveit_endpose_send(self, linear_message: dict, angular_message: dict = None):
        debug_message = {
            'joint_endpose': [0.099091, 0.00422, 0.46447, -0.09079689034052749, 0.7663049838381912,
        ...
        _message = {
            ...
            'max_velocity': 0.99,
            'max_acceleration': 0.99,
        }
        request = roslibpy.ServiceRequest(_message)
        resp = self.moveit_endpose_service.call(request)
        print("[Service] Sending message...", joint_endpose)
